...
import com.dn.signature.bean.Docs;
...
import com.dn.signature.exception.DefineException;
...
//        模拟环境（沙箱环境）域名：https://smlopenapi.esign.cn
    ...
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(b2cDemoSignature.class);
...
/**//*
ileTemplate.uploadFile(uploadUrl, filePath, HeaderConstant.CONTENTTYPE_PDF.VALUE());
