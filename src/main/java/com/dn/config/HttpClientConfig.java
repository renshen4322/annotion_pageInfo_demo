...
public class HttpClientConfig {
            ...
            public long getKeepAliveDuration(HttpResponse response, HttpContext httpContext) {
                ...
                while (it.hasNext()) {
                    ...
                    if (value != null && param.equalsIgnoreCase("timeout")) {
                        return Long.parseLong(value) * 10000;
                    }
                }
    ...
    public CloseableHttpClient httpClient() {
        RequestConfig requestConfig = RequestConfig.custom()
                // -1默认不超时 connectTimeout:-1, socketTimeout:-1, connectionRequestTimeout:-1
...
//                        connectionManager.closeIdleConnections(p.getCloseIdleConnectionWaitTimeSecs(), TimeUnit.SECONDS);
                        connectionManager.closeIdleConnections(30_000, TimeUnit.SECONDS);
                    } else {
