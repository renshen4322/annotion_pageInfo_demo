package com.dn.estest.searchafter;/*
...
public class HighlightSearch {
    ...
    public void highlightSearch() throws ParseException {
        ...
        ESDatas<Demo> esDatas =  //ESDatas包含当前检索的记录集合，最多1010条记录，由dsl中的size属性指定
                clientUtil.searchList("test_demo/_search",//demo为索引表，_search为检索操作action
